        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 font-semibold text-slate-900 hover:text-teal-600 transition-colors"
            >
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {walkthroughs.map((project, index) => (
              <motion.article
                ...
                whileHover={{ y: -6 }}
                className="group cursor-pointer overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-xl"
                onClick={() =>
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white text-slate-900 shadow-lg transition-transform group-hover:scale-110">
                      <Play
                        size={21}
                        fill="currentColor"
                        className="ml-1"
                ...
                <div className="p-6">
                  ...
                  <div className="mt-5 flex items-center gap-2 text-sm font-semibold text-slate-900 transition-colors group-hover:text-teal-600">
                    Watch project
                    <ArrowRight size={16} />
                  </div>
